...
# --- Expanded Scheduler Definitions ---
@dataclass
...
if __name__ == '__main__':
    ...
    # --- Expanded set of schedulers ---
    campaign_schedulers = [
        UniformSchedulerSpec(cadence_days=7, dwell_min=30),      # Weekly, 30 min
        UniformSchedulerSpec(cadence_days=14, dwell_min=30),     # Bi-weekly, 30 min
        UniformSchedulerSpec(cadence_days=30.44, dwell_min=60),  # Monthly, 60 min
